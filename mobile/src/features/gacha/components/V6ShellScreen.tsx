...
export function V6ShellScreen(props: {
  eyebrow: string;
  title: string;
  body: string;
  primaryLabel?: string;
      ...
      <LinearGradient colors={['#F5F3FF', '#FAF3E0']} style={styles.gradient}>
        <ScrollView contentContainerStyle={styles.container}>
          ...
          <View style={styles.card}>
            <Text style={styles.cardTitle}>Phase A shell</Text>
            <Text style={styles.cardBody}>This route is now present in mobile so the broader v6 product flow can be previewed and tested before deeper logic lands.</Text>
          </View>

...
// A data router, not <BrowserRouter>: useBlocker (the unsaved-changes guard on
// the card and deck editors) only works under createBrowserRouter/RouterProvider.
// The single splat route hands the whole path to App, so App's descendant
// <Routes> — the lazy pages, ChunkErrorBoundary and ConfirmDialogProvider — is
// unchanged; the router type is the only thing that moved.

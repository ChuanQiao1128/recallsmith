...
export function NewDeckPage() {
  ...
  const [form, setForm] = useState<NewDeckForm>({
    title: '',
    slug: '',
    author: 'RecallSmith Team', // 你可以改成自己的名字
    description: '',
    locale: 'en-US',
    deckType: 1,
  });
        ...
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">
              在这里创建一个新的题库，比如 <span className="font-mono">js-core-starter</span>。
            </p>
          </div>
          <Link
            to="/"
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              placeholder="JavaScript Core Basics (Starter)"
            />
              ...
              <div className="flex items-center gap-4 mt-1">
                <label className="inline-flex items-center gap-1 text-sm text-slate-700">
                  <input
                    ...
                    onChange={() => handleChange('deckType', 1)}
                ...
                <label className="inline-flex items-center gap-1 text-sm text-slate-700">
                  <input
                    ...
                    onChange={() => handleChange('deckType', 2)}
                    className="text-indigo-600 focus:ring-indigo-500 border-slate-300"
                  />
                  <span>Paid（收费题库）</span>
                </label>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="A deck for core JavaScript interview concepts..."
            />
          </div>
